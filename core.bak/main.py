    ...
    def school_manager(self):
        while True:
            for sch_name in self.school_file:
                print("\033[33;1m学校名称 : [%s]\033[0m" % sch_name)
            ...
            if sch_option in self.school_file:
                ...
                while True:
                    ...
                    if hasattr(self, user_action):
                        ...
                        print("\033[41;1m您的选项有误，请重新选择。\033[0m")
...
class Main(object):
    ...
    while not exit_flag:
        print(menu)
        user_ops = input("\033[37;1m请选择要管理的视图，[q] 退出>>:\033[0m").strip()
        if user_ops == '1':
            fc = School_view()
